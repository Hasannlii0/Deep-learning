...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Hasannlii0/Deep-learning/blob/main/NLP/ag-news-classification/AG_news_classification.ipynb)
...
```
ag-news-classification/
├── AG_news_classification.ipynb   # Data prep, tokenizer, model, training, inference
...
cd Deep-learning/NLP/ag-news-classification
```
